...
CHAIN IF ~NumTimesTalkedTo(0)~ THEN O#CRBOY task1
@10
END
...
@18
DO ~AddJournalEntry(@10560,QUEST) EscapeArea()~
EXIT
...
+ ~GlobalGT("O#CrLynnQuest","GLOBAL",0) Global("O#CrLynnBetrayed","GLOBAL",0) Global("O#CrLynnNineQuestsComplete","GLOBAL",0)~ + @781 DO ~SetGlobal("O#CrLynnBetrayed","GLOBAL",1) SetGlobal("O#CrLynnAmbush","GLOBAL",1)~ EXTERN HABREGA habrega1
+ ~Global("O#CrLynnBrega","GLOBAL",0) Global("O#CrLynnBetrayed","GLOBAL",1)~ + @782 DO ~SetGlobal("O#CrLynnBrega","GLOBAL",1)~ EXTERN HABREGA habrega2
+ ~Global("O#CrLynnBrega","GLOBAL",1) Global("O#CrLynnBetrayed","GLOBAL",1)~ + @783 DO ~SetGlobal("O#CrLynnBrega","GLOBAL",2)~ EXTERN HABREGA habrega3
...
+ ~GlobalGT("O#CrLynnQuest","GLOBAL",0) Global("O#CrLynnBetrayed","GLOBAL",0) Global("O#CrLynnNineQuestsComplete","GLOBAL",0)~ + @781 DO ~SetGlobal("O#CrLynnBetrayed","GLOBAL",1) SetGlobal("O#CrLynnAmbush","GLOBAL",1)~ EXTERN RENAL renal1
END
...
+ ~Global("O#CrLynnQuestSpawn1","GLOBAL",0) Global("O#CrLynnQuest","GLOBAL",1) OR(3) Time(21) Time(22) Time(23)~ + @797 DO ~SetGlobal("O#CrLynnQuestSpawn1","GLOBAL",1)~ EXTERN WINNKEEP O#CrMithrest1.1
+ ~!Time(21) !Time(22) !Time(23) Global("O#CrLynnQuest","GLOBAL",1) GlobalLT("O#CrLynnQuestSpawn1","GLOBAL",2)~ + @797 EXTERN WINNKEEP O#CrMithrest1.2
...
@799
DO ~AddJournalEntry(@10030,QUEST)~
EXIT
...
== O#CRQYR @1264
END
++ @1265 EXTERN O#CRQYR q2.0
++ @1266 EXTERN O#CRQYR q2.1
++ @1267 EXTERN O#CRQYR q2.2
