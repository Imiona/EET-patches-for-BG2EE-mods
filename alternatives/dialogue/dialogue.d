...
IF ~NumTimesTalkedToGT(0) GlobalLT("B!Alternatives","GLOBAL",7) !GlobalGT("WorkingForAran","GLOBAL",0) !GlobalGT("WorkingForBodhi","GLOBAL",0) !GlobalGT("B!Tourist","GLOBAL",7)~ THEN asterA
SAY @49 
++ @50 + asterA1
+ ~PartyGoldGT(14999)~ + @51 + aster23
++ @52 + aster23a
++ @53 + aster19
END 
...
++ @129 + aster31
++ @130 + aster28 
+ ~Class(Player1,THIEF_ALL)~ + @131 + aster29 
++ @132 + aster30 
END 
...
IF ~~ aster25 
SAY @134 /* Oh, crud. I'll need a contingency plan, after all */ 
IF ~~ THEN EXIT 
END 
...
IF ~!GlobalGT("B!Tourist","GLOBAL",7) Global("B!RefusedThieves","LOCALS",1) !Global("B!TouristThieves","GLOBAL",1)~THEN BEGIN mal_before_third 
SAY @321 
...
IF ~!GlobalGT("B!Tourist","GLOBAL",7) Global("B!TouristThieves","GLOBAL",1)~ THEN BEGIN mal_return
SAY @327  
...
IF ~~ mal13 
SAY @371 
IF ~~ THEN DO ~EraseJournalEntry(@143) 
EraseJournalEntry(@144) 
EraseJournalEntry(@143) 
EraseJournalEntry(@145) 
EraseJournalEntry(@146) 
...
IF ~!IsGabber(Player1)~ THEN BEGIN ahb0 
SAY @675  
IF ~~ THEN EXIT 
END 

IF ~IsGabber(Player1)~ THEN BEGIN ahb1 
SAY @676 
++ @677 + ahb3 
++ @678 + ahb2 
